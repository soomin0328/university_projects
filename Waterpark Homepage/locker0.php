...
<div style="margin-left:auto;margin-right: auto;text-align: center;">
  ...
  <h1><b>Reservation for Locker !!</b></h1>
  <h2><b>Please enter your Custom number & Password</b></h1>
    ...
    <form action="locker0.php" method="post">
      <tr>
       <td>
...
} else{echo "Now already login state!!";}
...
if($num_rows < 1){
  ...
  if($str > 0 && $pass > 0) {
    ...
    location.href='locker1.php'</script>";
    $_SESSION[id] = $id;
    $_SESSION[pass] = $pass;
